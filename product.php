...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .dropdown-row .form-group:last-child {
                margin-right: 0;
            }
        }
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Hide dropdowns if category-box, brand-box, or motor-box is visible
            function checkVisibility() {
                ...
                if (boxesVisible) {
                    ...
                    dropdowns.style.display = 'flex';  // Change this to flex to align in a row
                }
            }
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="category-tabs mt-4">
                        ...
                        <div class="dropdown-row animate dropdowns" style="display: flex;">
                            <div class="form-group">
                                <select class="form-control" onchange="window.location.href=this.value;">
                                    <option value="#">Select Category</option>
                                    <?php foreach ($categories as $category): ?>
                                        <option value="?category=<?= $category['idkategori'] ?>" <?= ($category['idkategori'] == $activeCategoryId) ? 'selected' : '' ?>>
                                            <?= htmlspecialchars($category['namakategori']) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                                ...
                                <div class="form-group">
                                    <select class="form-control" onchange="window.location.href=this.value;">
                                        ...
                                        <?php foreach ($brands as $brand): ?>
                                            <option value="?category=<?= $activeCategoryId ?>&brand=<?= $brand['idbrand'] ?>" <?= ($brand['idbrand'] == $activeBrandId) ? 'selected' : '' ?>>
                                                <?= htmlspecialchars($brand['namabrand']) ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <select class="form-control" onchange="window.location.href=this.value;">
                                        ...
                                        <?php foreach ($motors as $motor): ?>
                                            <option value="?category=<?= $activeCategoryId ?>&brand=<?= $activeBrandId ?>&motor=<?= $motor['idmotor'] ?>" <?= ($motor['idmotor'] == $activeMotorId) ? 'selected' : '' ?>>
                                                <?= htmlspecialchars($motor['namamotor']) ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                        ...
                        <!-- Original category, brand, and motor lists -->
